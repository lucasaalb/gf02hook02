const dores = [
  { text: "Ele tenta escrever e se confunde", icon: "😫", color: "bg-orange-50 text-orange-600" },
  { text: "Ele perde a paciência rápido", icon: "😵‍💫", color: "bg-blue-50 text-blue-600" },
  { text: "O celular parece mais interessante", icon: "📱", color: "bg-purple-50 text-purple-600" },
  { text: "Ele olha esperando sua ajuda", icon: "😢", color: "bg-rose-50 text-rose-600" },
  { text: "Você tem medo de ensinar errado", icon: "✍️", color: "bg-emerald-50 text-emerald-600" },
];
    ...
    <div className="container mx-auto px-4 max-w-4xl">
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl md:text-5xl font-heading font-extrabold text-primary-dark mb-6 text-balance leading-[1.1]">
          Sabe aqueles pequenos momentos <br className="hidden md:block" />
          que <span className="text-destructive underline decoration-destructive/20 underline-offset-8">apertam o coração</span>?
        </h2>
      </div>
      ...
      <div className="mt-16 text-center space-y-4 max-w-2xl mx-auto">
        <h3 className="text-2xl md:text-3xl font-heading font-extrabold text-primary-dark leading-tight">
          A alfabetização pode ser mais do que aprender letras.
        </h3>
        <p className="text-foreground/80 text-lg md:text-xl leading-relaxed">
          Pode ser o motivo para vocês ficarem mais perto.
        </p>
        <p className="text-primary font-bold italic text-lg pt-2">
          Às vezes, a criança aprende uma letra. Mas a avó ganha um lugar ainda mais bonito na memória dela.
        </p>
      </div>
    </div>
  </section>
