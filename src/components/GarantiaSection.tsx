  ...
  <section className="py-12 md:py-20 bg-section-alt">
    <div className="container mx-auto px-4 max-w-2xl text-center">
      ...
      <p className="text-foreground/80 text-sm md:text-base leading-relaxed max-w-md mx-auto">
        Acesse o material, olhe com calma e veja se ele faz sentido para a sua rotina com a criança. Se perceber que não é para você, devolvemos seu dinheiro.
      </p>
      <div className="flex items-center justify-center gap-2 mt-5 text-xs text-muted-foreground">
        ...
        <span>A ideia não é te pressionar, mas te dar um caminho simples.</span>
      </div>
    </div>
  </section>
);
